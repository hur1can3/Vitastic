...
public static class EndopointMapperExtensions
{
    ...
    {
        return services.AddEndpointMapper(configure, typeof(T));
    }
    ...
    {
        return services.AddEndpointMapper(configure, markers.Select(x => x.Assembly).ToArray());
    }
    ...
    {
        _ = app.UseMiddleware<EndpointMapperMiddleware>();
