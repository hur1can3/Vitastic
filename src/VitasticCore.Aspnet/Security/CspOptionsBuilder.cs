...
public sealed class CspOptionsBuilder
{
    ...
    {
        _ = directiveName.EnsureNotNull();

        Maybe<CspDirectiveBuilder> maybeBuilder = Maybe.From(_directiveBuilders.Find(d => d.Name == directiveName));
