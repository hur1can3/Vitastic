...
public sealed class CspSourceDirectiveBuilder
{
    ...
    {
        _ = _internalBuilder.Allow(source);
        return this;
    }
    ...
    /// </summary>
    public CspSourceDirectiveBuilder AllowUnsafeInline()
    {
    ...
    /// </summary>
    public CspSourceDirectiveBuilder AllowUnsafeEval()
    {
    ...
    /// </summary>
    public CspSourceDirectiveBuilder AllowNonce()
    {
        return AllowNonce(_nonce);
    }
    ...
    public CspSourceDirectiveBuilder AllowNonce(string base64Value)
    {
        return Allow($"'nonce-{base64Value}'");
    }
    ...
    public CspSourceDirectiveBuilder AllowHash(string algorithm, string base64Value)
    {
        return Allow($"'{algorithm}-{base64Value}'");
    }
}
